...
class MyStoresTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final visitsProvider = context.watch<UserVisitsProvider>();
    final visits = visitsProvider.visits.values.toList()
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.visit.storeId.toUpperCase(),
                    ...
                    Text(
                      '${TranslationKeys.visits.tr(context)}: ${widget.visit.visitCount} • ${TranslationKeys.ordersCount.tr(context)}: ${widget.visit.orderCount}',
                      style: TextStyle(
                        color: Theme.of(context).textTheme.bodyMedium?.color,
                        fontSize: 14,
                      ),
