...
class _AddressFormDialogState extends State<AddressFormDialog> {
  ...
  void initState() {
    ...
    _cityController = TextEditingController(
      text: widget.initialAddress?.city.ar ?? '',
    );
    _regionController = TextEditingController(
      text: widget.initialAddress?.region.ar ?? '',
    );
    _postalCodeController = TextEditingController(
      text: widget.initialAddress?.postalCode ?? '',
    );
    _countryController = TextEditingController(
      text: widget.initialAddress?.country.ar ?? '',
    );
  }
  ...
  void _saveAddress() {
    if (_formKey.currentState!.validate()) {
      final titleStr = _titleController.text.trim().isEmpty
          ? 'العنوان'
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        isEditing
                            ? TranslationKeys.editAddress.tr(context)
                            : TranslationKeys.addNewAddress.tr(context),
                        style: TextStyle(
                          fontSize: 24,
                  ...
                  AuthTextField(
                    ...
                    validator: (val) => val == null || val.isEmpty
                        ? TranslationKeys.requiredValidation.tr(context)
                        : null,
                  ),
                  const SizedBox(height: 16),
                  Row(
                  ...
                  SizedBox(
                    ...
                    child: ButtonApp(
                      ...
                      label: TranslationKeys.saveAddress.tr(context),
                    ),
                  ),
                ],
              ),
