...
class _RestaurantMenuBrandingPageState
  ...
  String _restaurantMenuThemeStyle =
      'chalkboard'; // 'chalkboard', 'italiano', 'modern'
  ...
  final TextEditingController _menuCoverTitleController = TextEditingController(
    text: 'THE FOOD RESTO MENU',
  );
  final TextEditingController _menuCoverSubtitleController =
      TextEditingController(
        text: 'استمتع بأشهى وأجود الوجبات والمأكولات الطازجة اليوم',
      );
  final TextEditingController _menuOfferBadgeController = TextEditingController(
                              ...
                              Wrap(
                                ...
                                children: [
                                  ...
                                  ChoiceChip(
                                    ...
                                    selected:
                                        _restaurantMenuThemeStyle == 'italiano',
                                  ...
                                  ChoiceChip(
                                    ...
                                    selected:
                                        _restaurantMenuThemeStyle == 'modern',
                          ...
                          _buildControlCard(
                            ...
                            children: [
                              SwitchListTile(
                                ...
                                onChanged: (val) =>
                                    setState(() => _showCaloriesBadges = val),
                                activeColor: Colors.deepOrange,
                              ),
                              SwitchListTile(
                                title: Text(
                                ...
                                onChanged: (val) =>
                                    setState(() => _showAllergensBadges = val),
                                activeColor: Colors.deepOrange,
                              ),
                              SwitchListTile(
                                title: Text(
                            ...
                            children: [
                              TextField(
                                ...
                                decoration: const InputDecoration(
                                  labelText:
                                      'عنوان الغلاف الرئيسي (Cover Title)',
                              ...
                              TextField(
                                ...
                                decoration: const InputDecoration(
                                  labelText:
                                      'شارة العرض الخاص (Offer Badge Text)',
                              ...
                              TextField(
                                ...
                                decoration: const InputDecoration(
                                  labelText:
                                      'رقم هاتف التواصل والتوصيل المباشر',
                        ...
                        children: [
                          ...
                          Expanded(
                            child: _mockupPageView == 0
                                ? _buildCoverPageMockup(themeAdmin)
                                : _buildLiveMenuMockup(themeAdmin),
                          ),
                        ],
                      ),
                    ),
  ...
  Widget _buildCoverPageMockup(ThemeAdmin t) {
  ...
  Widget _buildLiveMenuMockup(ThemeAdmin t) {
    Color primaryColor = t.primaryColorValue;
    Color bgColor = t.backgroundColorValue;
    Color surfaceColor = t.surfaceColorValue;
    Color textColor = t.textColorValue;
