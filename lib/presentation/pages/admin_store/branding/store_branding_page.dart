...
class _StoreBrandingPageState extends State<StoreBrandingPage> {
  ...
  static const List<Map<String, String>> _logoGallery = [
    {
      'title': 'لوجو حديث',
      'url': 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=150',
    },
    {
      'title': 'لوجو موضة',
  ...
  StoreTheme get _currentTheme => StoreTheme(
  ...
  Future<void> _saveTheme() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('تم حفظ وتطبيق ثيم وهوية المتجر فوراً على كافة صفحات متجرك!'),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Expanded(child: _buildStoreMockupPreview(_currentTheme)),
                              ],
                            ),
                          ),
                        ),
  ...
  // ───────────────────────────────────────────────
  void _showMockupCartModal(StoreTheme t) {
    final primaryColor = t.primaryColorValue;
    final surfaceColor = _mockupIsDarkMode ? const Color(0xFF1E1E22) : t.surfaceColorValue;
    final textColor = _mockupIsDarkMode ? const Color(0xFFF4F4F5) : t.textColorValue;
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      _mockupIsArabic ? 'سلة التسوق (2 منتجات)' : 'Shopping Cart (2 Items)',
                      style: TextStyle(
                ...
                _buildCartItemRow(
                  t,
                  title: _mockupIsArabic ? 'قميص كاجوال مودرن' : 'Modern Casual Shirt',
                  price: '\$49.99',
                ...
                _buildCartItemRow(
                  t,
                  title: _mockupIsArabic ? 'حذاء رياضي أنيق' : 'Elegant Sports Shoes',
                  price: '\$89.99',
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(
                      _mockupIsArabic ? 'متابعة الدفع والشراء' : 'Proceed to Checkout',
                      style: TextStyle(
                        fontFamily: t.fontFamily,
                        fontWeight: FontWeight.bold,
                      ),
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Text('1', style: TextStyle(fontWeight: FontWeight.bold, color: textColor)),
            const SizedBox(width: 8),
            Container(
              padding: const EdgeInsets.all(4),
              decoration: BoxDecoration(
                ...
                Row(
                  children: ['S', 'M', 'L', 'XL'].map((sz) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        color: isM ? primaryColor : primaryColor.withOpacity(0.1),
                        borderRadius: t.buttonBorderRadius,
                      ),
                      child: Text(
                        sz,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(_mockupIsArabic ? 'تمت إضافة $title للسلة بنجاح!' : 'Added $title to cart!'),
                          backgroundColor: primaryColor,
                    ...
                    label: Text(
                      _mockupIsArabic ? 'إضافة إلى سلة التسوق' : 'Add to Shopping Cart',
                      style: TextStyle(
                        fontFamily: t.fontFamily,
                        fontWeight: FontWeight.bold,
                      ),
  ...
  void _showMockupFilterModal(StoreTheme t) {
    final primaryColor = t.primaryColorValue;
    final surfaceColor = _mockupIsDarkMode ? const Color(0xFF1E1E22) : t.surfaceColorValue;
    final textColor = _mockupIsDarkMode ? const Color(0xFFF4F4F5) : t.textColorValue;
      ...
      builder: (ctx) {
        return Directionality(
          ...
          child: AlertDialog(
            ...
            title: Text(
              _mockupIsArabic ? 'تصفية المنتجات (Filter Products)' : 'Filter Products',
              style: TextStyle(fontFamily: t.fontFamily, fontSize: 16 * t.fontScale, color: textColor, fontWeight: FontWeight.bold),
            ),
            content: Column(
              mainAxisSize: MainAxisSize.min,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(_mockupIsArabic ? 'نطاق السعر (\$10 - \$200):' : 'Price Range (\$10 - \$200):', style: TextStyle(color: textColor, fontSize: 12)),
                Slider(value: 80, min: 10, max: 200, activeColor: primaryColor, onChanged: (_) {}),
                const SizedBox(height: 10),
                Text(_mockupIsArabic ? 'التقييم:' : 'Rating:', style: TextStyle(color: textColor, fontSize: 12)),
                Row(
                  children: [
                    for (int i = 0; i < 5; i++) Icon(Icons.star_rounded, color: Colors.amber.shade700, size: 20),
                  ],
                ),
              ],
            ),
            actions: [
              TextButton(onPressed: () => Navigator.pop(ctx), child: Text(_mockupIsArabic ? 'إلغاء' : 'Cancel')),
              ElevatedButton(
                onPressed: () => Navigator.pop(ctx),
                style: ElevatedButton.styleFrom(backgroundColor: primaryColor, shape: RoundedRectangleBorder(borderRadius: t.buttonBorderRadius)),
                child: Text(_mockupIsArabic ? 'تطبيق الفلترة' : 'Apply Filter', style: const TextStyle(color: Colors.white)),
              ),
            ],
          ),
        );
  ...
  void _showMockupCheckoutDialog(StoreTheme t) {
    final primaryColor = t.primaryColorValue;
    showDialog(
      context: context,
      builder: (ctx) => Directionality(
        ...
        child: AlertDialog(
          ...
          title: Row(
            children: [
              Icon(Icons.check_circle_rounded, color: t.secondaryColorValue, size: 28),
              const SizedBox(width: 8),
              Text(_mockupIsArabic ? 'تأكيد الطلب والشراء' : 'Order Confirmation', style: TextStyle(fontFamily: t.fontFamily, fontSize: 15 * t.fontScale, fontWeight: FontWeight.bold)),
            ],
          ),
          content: Text(
            _mockupIsArabic ? 'هل ترغب بإتمام الطلب بمبلغ \$139.98 والتوصيل للعنوان المسجل؟' : 'Would you like to complete checkout for \$139.98?',
            style: TextStyle(fontFamily: t.fontFamily, fontSize: 12 * t.fontScale),
          ),
          actions: [
            TextButton(onPressed: () => Navigator.pop(ctx), child: Text(_mockupIsArabic ? 'تراجع' : 'Cancel')),
            ElevatedButton(
              onPressed: () {
                Navigator.pop(ctx);
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text(_mockupIsArabic ? 'تم إرسال الطلب بنجاح! شكراً لتسوقك.' : 'Order placed successfully! Thank you.'), backgroundColor: t.secondaryColorValue),
                );
              },
              style: ElevatedButton.styleFrom(backgroundColor: primaryColor, shape: RoundedRectangleBorder(borderRadius: t.buttonBorderRadius)),
              child: Text(_mockupIsArabic ? 'تأكيد ودفع' : 'Confirm & Pay', style: const TextStyle(color: Colors.white)),
            ),
          ],
        ),
      ),
  ...
  void _showMockupCouponDialog(StoreTheme t) {
    final primaryColor = t.primaryColorValue;
    showDialog(
      context: context,
      builder: (ctx) => Directionality(
        ...
        child: AlertDialog(
          ...
          title: Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text(_mockupIsArabic ? 'تطبيق كود الخصم' : 'Apply Coupon Code', style: TextStyle(fontFamily: t.fontFamily, fontSize: 15 * t.fontScale, fontWeight: FontWeight.bold)),
            ],
          ),
          content: TextField(
            decoration: InputDecoration(
              hintText: _mockupIsArabic ? 'ادخل كود الخصم (مثال: SUMMER40)' : 'Enter coupon code (e.g. SUMMER40)',
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pop(ctx);
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text(_mockupIsArabic ? 'تم تفعيل خصم 20% بنجاح!' : 'Coupon applied 20% OFF!'), backgroundColor: primaryColor),
                );
              },
              style: ElevatedButton.styleFrom(backgroundColor: t.secondaryColorValue, shape: RoundedRectangleBorder(borderRadius: t.buttonBorderRadius)),
              child: Text(_mockupIsArabic ? 'تطبيق الخصم' : 'Apply Discount', style: const TextStyle(color: Colors.white)),
            ),
          ],
        ),
      ),
  ...
  void _showMockupShareDialog(StoreTheme t) {
    showDialog(
      context: context,
      builder: (ctx) => Directionality(
        textDirection: _mockupIsArabic ? TextDirection.rtl : TextDirection.ltr,
        child: AlertDialog(
          ...
          title: Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text(_mockupIsArabic ? 'مشاركة رابط المتجر' : 'Share Store Link', style: TextStyle(fontFamily: t.fontFamily, fontSize: 15 * t.fontScale, fontWeight: FontWeight.bold)),
            ],
          ),
          content: Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              IconButton(icon: const Icon(Icons.send_rounded, color: Colors.green), onPressed: () => Navigator.pop(ctx)),
              IconButton(icon: const Icon(Icons.camera_alt_rounded, color: Colors.pink), onPressed: () => Navigator.pop(ctx)),
              IconButton(icon: const Icon(Icons.copy_rounded, color: Colors.indigo), onPressed: () => Navigator.pop(ctx)),
            ],
          ),
        ),
      ),
        ...
        children: [
          ...
          InkWell(
            ...
            child: Container(
              padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
              decoration: BoxDecoration(
                color: _mockupIsDarkMode ? const Color(0xFF27272A) : const Color(0xFFFEF3C7),
                borderRadius: BorderRadius.circular(20),
              ),
              child: Row(
                children: [
                  Icon(
                    _mockupIsDarkMode ? Icons.dark_mode_rounded : Icons.light_mode_rounded,
                    size: 13,
                    color: _mockupIsDarkMode ? Colors.amber : const Color(0xFFD97706),
                  ),
                  const SizedBox(width: 4),
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 10,
                      fontWeight: FontWeight.bold,
                      color: _mockupIsDarkMode ? Colors.white : const Color(0xFFD97706),
                    ),
                  ),
                ],
              ),
  ...
  // ───────────────────────────────────────────────
  Widget _buildStoreMockupPreview(StoreTheme t) {
    final primaryColor = t.primaryColorValue;

    final bgColor = _mockupIsDarkMode ? const Color(0xFF141416) : t.backgroundColorValue;
    final surfaceColor = _mockupIsDarkMode ? const Color(0xFF1E1E22) : t.surfaceColorValue;
    final textColor = _mockupIsDarkMode ? const Color(0xFFF4F4F5) : t.textColorValue;
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Icon(
                          _mockupIsDarkMode ? Icons.light_mode_rounded : Icons.dark_mode_rounded,
                          size: 14,
                          color: primaryColor,
                        ),
                      ),
              ...
              Container(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        _mockupIsArabic ? 'أفخم التشكيلات المودرن' : 'Premium Modern Collection',
                        style: TextStyle(
                          fontFamily: t.fontFamily,
                          fontSize: 16 * t.fontScale,
                          fontWeight: FontWeight.bold,
                      ...
                      Text(
                        _mockupIsArabic ? 'خصومات تصل حتى 40%' : 'Discounts up to 40% OFF',
                        style: TextStyle(
                          fontFamily: t.fontFamily,
                          fontSize: 11 * t.fontScale,
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    _buildMockupCategoryPill(t, index: 0, label: _mockupIsArabic ? 'الكل' : 'All', primaryColor: primaryColor, surfaceColor: surfaceColor, textColor: textColor),
                    const SizedBox(width: 8),
                    _buildMockupCategoryPill(t, index: 1, label: _mockupIsArabic ? 'أزياء' : 'Fashion', primaryColor: primaryColor, surfaceColor: surfaceColor, textColor: textColor),
                    const SizedBox(width: 8),
                    _buildMockupCategoryPill(t, index: 2, label: _mockupIsArabic ? 'إلكترونيات' : 'Electronics', primaryColor: primaryColor, surfaceColor: surfaceColor, textColor: textColor),
                    const SizedBox(width: 8),
                    _buildMockupCategoryPill(t, index: 3, label: _mockupIsArabic ? 'ساعات' : 'Watches', primaryColor: primaryColor, surfaceColor: surfaceColor, textColor: textColor),
                  ],
                ),
              ),
              const SizedBox(height: 14),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 8),
                          Text(
                            _mockupIsArabic ? 'ابحث عن المنتجات هنا...' : 'Search products here...',
                            style: TextStyle(
                              fontFamily: t.fontFamily,
                              fontSize: 11 * t.fontScale,
                ...
                children: [
                  Expanded(
                    child: _buildMockupProductCard(
                      ...
                      onFavTap: () => setState(() => _product1Favorite = !_product1Favorite),
                  ...
                  Expanded(
                    child: _buildMockupProductCard(
                      ...
                      onFavTap: () => setState(() => _product2Favorite = !_product2Favorite),
                      onTap: () => _showMockupProductDetailModal(
                        t,
                        title: _mockupIsArabic ? 'حذاء رياضي أنيق' : 'Elegant Sports Shoes',
                        price: '\$89.99',
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      _mockupIsArabic ? 'معرض أزرار التفاعل (انقر لتجربة النوافذ المنبثقة):' : 'Interactive Buttons (Click to test dialogs):',
                      style: TextStyle(
                        fontFamily: t.fontFamily,
                        fontSize: 11 * t.fontScale,
                        fontWeight: FontWeight.bold,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      _mockupIsArabic ? 'عنوان رئيسي عريض (Heading H1)' : 'Main Heading Title H1',
                      style: TextStyle(
                        fontFamily: t.fontFamily,
                        fontSize: 16 * t.fontScale,
                        fontWeight: FontWeight.bold,
                    ...
                    const SizedBox(height: 2),
                    Text(
                      _mockupIsArabic ? 'عنوان فرعي توضيحي (Subtitle H2)' : 'Subtitle Secondary Text H2',
                      style: TextStyle(
                        fontFamily: t.fontFamily,
                        fontSize: 12 * t.fontScale,
                        color: textColor.withOpacity(0.7),
                    ...
                    const SizedBox(height: 4),
                    Text(
                      _mockupIsArabic ? 'هذا نص الفقرة العادي للتأكد من سهولة القراءة وتناسق الخط.' : 'This is standard body paragraph text to ensure legibility and contrast.',
                      style: TextStyle(
                        fontFamily: t.fontFamily,
                        fontSize: 11 * t.fontScale,
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.local_shipping_rounded, size: 16, color: primaryColor),
                    const SizedBox(width: 8),
                    Expanded(
                      child: Text(
                        _mockupIsArabic ? '🚚 شحن مجاني وسريع لجميع الطلبات اليوم!' : '🚚 Fast Free Shipping on all orders today!',
                        style: TextStyle(
                          fontFamily: t.fontFamily,
              ...
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    _buildMockupNavItem(t, index: 0, icon: Icons.home_rounded, label: _mockupIsArabic ? 'الرئيسية' : 'Home', primaryColor: primaryColor, textColor: textColor),
                    _buildMockupNavItem(t, index: 1, icon: Icons.grid_view_rounded, label: _mockupIsArabic ? 'الأقسام' : 'Categories', primaryColor: primaryColor, textColor: textColor),
                    _buildMockupNavItem(t, index: 2, icon: Icons.favorite_border_rounded, label: _mockupIsArabic ? 'المفضلة' : 'Wishlist', primaryColor: primaryColor, textColor: textColor),
                    _buildMockupNavItem(t, index: 3, icon: Icons.person_outline_rounded, label: _mockupIsArabic ? 'حسابي' : 'Profile', primaryColor: primaryColor, textColor: textColor),
                  ],
                ),
              ),
            ],
  ...
  Widget _buildMockupNavItem(
    ...
    return InkWell(
      ...
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, size: 18, color: isSelected ? primaryColor : textColor.withOpacity(0.5)),
          const SizedBox(height: 2),
          Text(
            label,
            style: TextStyle(
    ...
    return Column(
      ...
      children: [
            ...
            Wrap(
              ...
              children: [
                ..._primaryPalette.map((item) {
                  final hex = item['hex']!;
                  final isSelected = _primaryColorHex.toLowerCase() == hex.toLowerCase();
                  return ChoiceChip(
                    label: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        CircleAvatar(radius: 8, backgroundColor: _parseColor(hex)),
                        const SizedBox(width: 8),
                        Text(item['name']!),
                      ],
                    ),
            ...
            Wrap(
              ...
              children: [
                ..._secondaryPalette.map((item) {
                  final hex = item['hex']!;
                  final isSelected = _secondaryColorHex.toLowerCase() == hex.toLowerCase();
                  return ChoiceChip(
                    label: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                    ...
                    selected: isSelected,
                    onSelected: (val) => setState(() => _secondaryColorHex = hex),
                    selectedColor: _parseColor(hex).withOpacity(0.18),
                  );
                }),
                ActionChip(
          ...
          children: [
            ...
            ActionChip(
              ...
              onPressed: () {
                ...
                final softTint = Color.alphaBlend(primary.withOpacity(0.04), Colors.white);
                final hexString = '#${softTint.value.toRadixString(16).substring(2).toUpperCase()}';
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('تم تطبيق لون خلفية ناعم وخفيف جداً مشتق من لون متجرك ($hexString)!'),
          ...
          children: [
            Wrap(
              ...
              children: _fontFamilies.map((font) {
                ...
                return ChoiceChip(
                  label: Text(font, style: TextStyle(fontFamily: font, fontWeight: FontWeight.bold)),
                  selected: isSelected,
                  onSelected: (val) => setState(() => _selectedFontFamily = font),
                );
              }).toList(),
            ),
            const SizedBox(height: 16),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('مقياس حجم الخط (Font Scale)', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                Text('${_fontScale.toStringAsFixed(2)}x', style: const TextStyle(fontWeight: FontWeight.bold)),
              ],
            ),
            Slider(
              value: _fontScale,
        ...
        _buildControlSectionCard(
          ...
          children: [
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('انحناء الأزرار (Button Radius)', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                Text('${_buttonRadius.toInt()}px', style: const TextStyle(fontWeight: FontWeight.bold)),
              ],
            ),
            Slider(
              value: _buttonRadius,
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('انحناء كروت المنتجات (Card Radius)', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                Text('${_cardRadius.toInt()}px', style: const TextStyle(fontWeight: FontWeight.bold)),
              ],
            ),
            Slider(
              value: _cardRadius,
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('انحناء حقول البحث والإدخال (Input Radius)', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                Text('${_inputRadius.toInt()}px', style: const TextStyle(fontWeight: FontWeight.bold)),
              ],
            ),
            Slider(
              value: _inputRadius,
        ...
        _buildControlSectionCard(
          ...
          children: [
            const Text('اختر شعار المتجر (Store Logo)', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            SizedBox(
              height: 70,
            ...
            const SizedBox(height: 16),
            const Text('اختر غلاف المتجر الرئيسي (Header Cover Banner)', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            SizedBox(
              height: 80,
              child: ListView.separated(
      ...
      builder: (ctx) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            ...
            final hexString = '#${currentColor.value.toRadixString(16).substring(2).toUpperCase()}';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Align(
                        ...
                        child: Text('طيف درجة اللون (Hue Spectrum):', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                      ),
                      const SizedBox(height: 8),
                      Container(
                        height: 22,
                      ...
                      const Align(
                        alignment: Alignment.centerRight,
                        child: Text('درجة تشبع اللون (Saturation & Shade):', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                      ),
                      const SizedBox(height: 8),
                      Slider(
                        value: saturation,
                      ...
                      const Align(
                        alignment: Alignment.centerRight,
                        child: Text('درجات سريعة جاهزة:', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                      ),
                      const SizedBox(height: 10),
                      Wrap(
                        spacing: 8,
                        ...
                        children: [
                          for (var c in [
                            const Color(0xFFF43F5E), const Color(0xFFEC4899), const Color(0xFFD946EF), const Color(0xFFA855F7),
                            const Color(0xFF8B5CF6), const Color(0xFF6366F1), const Color(0xFF3B82F6), const Color(0xFF0EA5E9),
                            const Color(0xFF06B6D4), const Color(0xFF14B8A6), const Color(0xFF10B981), const Color(0xFF22C55E),
                            const Color(0xFF84CC16), const Color(0xFFEAB308), const Color(0xFFF59E0B), const Color(0xFFF97316),
                            const Color(0xFFEF4444), const Color(0xFF78716C), const Color(0xFF18181B), const Color(0xFF0F172A),
                          ]) ...[
                            GestureDetector(
                              onTap: () {
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  shape: BoxShape.circle,
                                  border: Border.all(
                                    color: currentColor == c ? Colors.black : Colors.white,
